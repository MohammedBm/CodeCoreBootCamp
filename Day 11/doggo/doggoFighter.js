...
module.exports = class doggoFighter extends Doggo {
  ...
  fight(doggoFighter){
    ...
    if (doggoFighter.hitPoints <= 0) {
      ...
      return `${ this.name } has ${ this.hitPoints } health \nand is battling ${ doggoFighter.name } and his health is ${ doggoFighter.hitPoints }. And his special attack is ${ this.specialAttack }.\n And the attacker was ${ attacker }\n------------------------------`;
    }
